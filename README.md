...
**[致谢](#感谢下述及其他被使用到的开源代码项目贡献者来自这些项目的代码及衍生代码遵循其原有开源协议不受本项目的gpl授权影响)**
...
日期  | 类型 |  更新内容 | 图
------- | :--:  | :--: | :-------
05-12 | 更新 | 用户做题可得积分(金币)，管理员可给用户积分奖励，积分可由管理员进行消费抵扣(线下奖励)，用户自行二次开发可增加积分买题、买比赛功能。| <img width="227" height="48" alt="image" src="https://github.com/user-attachments/assets/b89faa7c-5021-4e01-b289-edc94385dcd3" />
