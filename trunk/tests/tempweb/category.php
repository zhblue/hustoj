...
if (!$result) {
    ...
    foreach ($category as $cat) {
        ...
        $view_category .= "<a class='badge $bs5_badge' style='display: inline-block; margin:5px ' href='problemset.php?search=" . htmlentities(urlencode($cat), ENT_QUOTES, 'utf-8') . "'>" . htmlentities($cat, ENT_QUOTES, 'utf-8') . "</a>&nbsp;";
