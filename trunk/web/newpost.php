                        ...
                        <tr>
                            <td>
                                <input type=hidden name=cid
                                       value="<?php if (isset($_REQUEST['cid'])) echo intval($_REQUEST['cid']); ?>">
                                <?php echo $MSG_PROBLEM_ID ?> :
                                <div>
                                    <input name=pid
                                           style="border:1px dashed #8080FF; width:100px; height:20px; font-size:100%;margin:0 10px; padding:2px 10px"
                                           value="<?php echo $pid; ?>">
                                </div>
                                <br>
                                <?php echo $MSG_TITLE ?> :
                                <div>
                                    <input name=title
                                           style="border:1px dashed #8080FF; width:700px; height:20px; font-size:100%;margin:0 10px; padding:2px 10px">
                                </div>
                                <br>
                                <?php echo $MSG_QUESTION ?> :
                                <div>
                                    <textarea name=content
                                              style="border:1px dashed #8080FF; width:700px; height:200px; font-size:100%; margin:0 10px; padding:10px"></textarea>
                                </div>
                                <div style="float:right;font-size:80%">
                                    ...
                                    <?php } ?>
                                    <input type="submit" style="margin:5px 10px"
                                           value="<?php echo $MSG_REGISTER_QUESTION ?>"></input>
                                </div>
                            </td>
                        </tr>
                    </table>
