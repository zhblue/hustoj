...
//SaaS friendly
 $MSG_TEMPLATE="Template";
  ...
  $MSG_FRIENDLY_L9="Allow guest to submit";
	...
	$MSG_MARK="Mark";
	$MSG_LAST_MONTH="อันดับเดือนที่แล้ว";
  ...
  $MSG_BONUS="โบนัส";
  $MSG_COIN="เหรียญ";
  $MSG_COIN_BALANCE="ยอด {$MSG_COIN} ปัจจุบัน";
  $MSG_COIN_BONUS="โบนัสจากครู {$MSG_COIN}";
  $MSG_COIN_EARNED="ได้ {$MSG_COIN} จากการแก้ปัญหา";
  $MSG_COIN_SPENT="ใช้ {$MSG_COIN}";
  $MSG_EARNED="ได้รับ";
  $MSG_FRIENDLY_B1="ปิดการลงทะเบียน บังคับเข้าสู่ระบบ";
  $MSG_NO_COIN="{$MSG_COIN} ไม่เพียงพอ";
  $MSG_PAID="ชำระ {$MSG_COIN} แล้ว";
  $MSG_SPENT="ใช้ไป";
