<?php
	//header.php
	$MSG_FAQ="དྲི་བ་ལན་གྲངས།";
	$MSG_BBS="བགོས་ཆས།";
	$MSG_HOME="གྱི་ཁྱིམ།";
	$MSG_PROBLEMS="གནས་རིམ།";
	$MSG_STATUS="གནས་ཚུལ།";
	$MSG_RANKLIST="གྲགས་རིམ།";
	$MSG_CONTEST="འགྲན་བསྡུ།";
	...
	$MSG_TODO="འགན་ལེན།";
	//status.php
	$MSG_Pending="འོག་ཏུ་སྒུག";
	$MSG_Pending_Rejudging="བསྐྱར་གཏན་།";
	$MSG_Compiling="བསྒྲིག་བཞིན།";
	$MSG_Running_Judging="གཉེར་སྒྲིག་བཞིན།";
	$MSG_Accepted="འགྲིག";
	$MSG_Presentation_Error="བཀོད་སྒོ་ནོས་པ།";
	$MSG_Wrong_Answer="ལན་འདྲི།";
	$MSG_Time_Limit_Exceed="དུས་ཚོད་བརྒལ།";
	$MSG_Memory_Limit_Exceed="ཉེར་མཁོའི་བརྒལ།";
	$MSG_Output_Limit_Exceed="འབུར་ཐོན་བརྒལ།";
	$MSG_Runtime_Error="གཉེར་སྐབས་ནོས།";
	$MSG_Compile_Error="བསྒྲིག་སྐབས་ནོས།";
	$MSG_Runtime_Click="གཉེར་སྐབས་ནོས།(གནོན།)";
	$MSG_Compile_Click="བསྒྲིག་སྐབས་ནོས།(གནོན།)";
	$MSG_Compile_OK="བསྒྲིག་ལེགས།";
	$MSG_Click_Detail="གསལ་རྒྱན་གནོན།";
	$MSG_Manual="རང་སྒོ་།";
	$MSG_OK="འདེམ།";
	$MSG_Explain="རྒྱུ་མཚན་འབྲི།";
	$MSG_TEST_RUN="ཚོད་ལེན།";
	$MSG_MARK="གྲངས།";
	$MSG_MANUAL_CONFIRMATION="རང་སྒོ་གཏན་འབེབ་སྒུག";
	$MSG_MC="ManualConfirm";
	$MSG_SUBMITTING="འབུད་བཞིན།";
	$MSG_REMOTE_PENDING="རྒྱང་འོག་སྒུག";
	$MSG_REMOTE_JUDGING="རྒྱང་འགྲིག";
	$MSG_RP="རྒྱང་འོག་སྒུག";
	$MSG_RUNID="གཉེར་ཨང་།";
	$MSG_USER="སྤྱོད་བདག";
	$MSG_PROBLEM="གནས་རིམ།";
	$MSG_RESULT="འབྲས་བུ།";
	...
	$MSG_TIME="དུས།";
	$MSG_LANG="སྐད།";
	$MSG_CODE_LENGTH="ཀུན་རྩིས།";
	$MSG_SUBMIT_TIME="འབུད་དུས།";
	...
	$MSG_PE="བཀོད་ནོས།";
	$MSG_WA="ལན་འདྲི།";
	$MSG_TLE="དུས་ཚོད་བརྒལ།";
	$MSG_MLE="ཉེར་མཁོའི་བརྒལ།";
	$MSG_OLE="འབུར་ཐོན་བརྒལ།";
	$MSG_RE="གཉེར་ནོས།";
	$MSG_CE="བསྒྲིག་ནོས།";
	$MSG_CO="འབུར་འགྲིག";
	$MSG_TR="Test";
	$MSG_RESET="བསྐྱར་སྒོག";
	//problemset.php
	$MSG_SEARCH="འཚོལ།";
	$MSG_PROBLEM_ID="གནས་རིམ་ཨང་།";
	$MSG_TITLE="མགོ་མཇུག";
	$MSG_SOURCE="འབྱུང་ཁུང།";
	$MSG_SUBMIT_NUM="འབུད་གྲངས།";
	$MSG_SUBMIT="འབུད།";
	...
	$MSG_DAY="Day-Rank";
	$MSG_WEEK="Week-Rank";
	$MSG_LAST_MONTH="ཕྱི་ཟླ་གྲགས་རིམ";
	$MSG_MONTH="Month-Rank";
	$MSG_YEAR="Year-Rank";
	$MSG_ABSENT="Absent";
	//registerpage.php
	$MSG_USER_ID="སྤྱོད་བདག་ID";
	$MSG_PASSWORD="གསང་ཨང་།";
...
$MSG_CLICK_VIEW_HINT="Click to View Spoiler";
	...
	$MSG_REJUDGE="བསྐྱར་གཏན།";
	$MSG_PRIVILEGE="དབང་ཆ།";
	$MSG_GIVESOURCE="GiveSource";
	$MSG_IMPORT="ནང་འདྲེན།";
	$MSG_EXPORT="ཕྱིར་འདྲེན།";
	...
	$MSG_START_TIME="འགོ་དུས།";
	$MSG_END_TIME="མཇུག་དུས།";
	$MSG_CONTEST_ID="འགྲན་ཨང་།";
	$MSG_VIEW_ALL_CONTESTS="འགྲན་ཆ་མཐོང་།";
	$MSG_VIEW_MY_CONTESTS="My Contests Only";
	$MSG_CONTEST_NAME="འགྲན་མི།";
	$MSG_CONTEST_STATUS="འགྲན་གནས།";
	...
	$MSG_MY_SUBMISSIONS="ངའི་འབུད་།";
	$MSG_MY_CONTESTS="ངའི་འགྲན།";
	$MSG_Creator="Creator";
  ...
  $MSG_HELP_SETTINGS="Modify system configuration parameters via web UI (booleans, text, numbers); sensitive items are protected";
	...
	$MSG_WARNING_USER_ID_SHORT="ID་3་ཡི་གྲངས་ཉུང་།";
	$MSG_WARNING_PASSWORD_SHORT="གསང་ཨང་6་ཡི་གྲངས་ཉུང་།";
	$MSG_WARNING_REPEAT_PASSWORD_DIFF="གསང་ཨང་་གཉིས་མ་མཐུད།";
	...
	$MSG_NEW_CONTEST="གསར་འགྲན།";
	$MSG_AVAILABLE="སྤྱོད་ཆོད།";
	$MSG_NEW_PROBLEM_LIST="NewProblemList";
	$MSG_DELETE="བསུབ།";
	$MSG_EDIT="བཟོ་བཅོས།";
	$MSG_TEST_DATA="ཚོད་གཞི།";
