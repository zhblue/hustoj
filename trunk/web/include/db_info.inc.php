...
static 	$DB_RO_USER="root";  //数据库只读账户
static 	$DB_RO_PASS="root";  //数据库只读密码
...
static  $OJ_BBCODE_IN_PROBLEM=false;
...
$gconfig=dirname(dirname(dirname(dirname(__FILE__))))."/global.php";
if(file_exists($gconfig)) require_once($gconfig);
