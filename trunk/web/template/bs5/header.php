...
$(document).ready(function(){
  var msg = "<marquee class='mb-3 text-muted' id=broadcast direction='left' scrollamount=3 scrolldelay=50 onMouseOver='this.stop()' onMouseOut='this.start()'>"+<?php echo json_encode($view_marquee_msg); ?>+"</marquee>";
