        ...
        <div class="mdui-row" style="display: flex; justify-content: center;">
            <div class="mdui-card mdui-col-sm-6" style="text-align: left;">
                <div class="mdui-card-primary">
                    ...
                    <div class="mdui-card-primary-subtitle" style="text-align: center">填写信息 (1/2)</div>
                </div>
                <form action="lostpassword.php" method="post" role="form"
                    ...
                    <div style="position: relative;">
                        ...
                        <div class="mdui-textfield mdui-textfield-floating-label"
                            ...
                            <input class="mdui-textfield-input" name="email" type="email" autocomplete="off" required />
                    ...
                    <div class="mdui-row" style="position: relative;">
                        ...
                        <div class="mdui-textfield mdui-textfield-floating-label mdui-col-xs-4" style="display: inline-block; margin-left: 45px;">
                            ...
                            <input class="mdui-textfield-input" autocomplete="off" name="vcode" type="text" autocomplete=off  required/>
