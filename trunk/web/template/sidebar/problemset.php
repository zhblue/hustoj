    ...
    <?php
		...
		echo "<tr>";
            if (isset($_SESSION[$OJ_NAME.'_'.'user_id'])){
             ...
             echo "</a>";
             if($row['defunct']=='Y')
              {echo "<a href=admin/problem_df_change.php?id=".$row['problem_id']."&getkey=".htmlentities($_SESSION[$OJ_NAME.'_'.'getkey'], ENT_QUOTES, 'UTF-8').">".("<span class=\"ui tiny red label\">未公开</span>")."</a>";}
