...
<form method="post" class="form-horizontal">
	...
	<div class="form-group">
		...
		<?php
			$rightarray = array("administrator","problem_editor","problem_importer","tag_adder","problem_verifiter","source_browser","contest_creator","user_adder","http_judge","password_setter","printer","balloon","vip",'problem_start','problem_end');
